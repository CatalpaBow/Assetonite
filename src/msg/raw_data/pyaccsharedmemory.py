...
def read_graphics_map(graphic_map: accSM) -> GraphicsMap:
    ...
    return GraphicsMap(
        ...
        current_time_str=str(temp["currentTime"]),
        last_time_str=str(temp["lastTime"]),
        best_time_str=str(temp["bestTime"]),
        last_sector_time_str=str(temp["lastSectorTime"]),
        ...
        surface_grip=float(temp['surfaceGrip']),
...
def read_static_map(static_map: accSM) -> StaticsMap:
    ...
    return StaticsMap(
        ...
        temp["maxRpm"],
        temp["maxFuel"],
        Wheels(*temp["suspensionMaxTravel"]),
